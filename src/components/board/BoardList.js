...
const BoardList = () => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:9999/board', requestOptions)
    ...
    return (
        (data.length === 0) ?
            ...
            <>
                <div className="h1 fw-bolder">BOARDS</div>
                            ...
                            data.map((value, key) => {
                                return <div className="card m-2 bg-dark bg-opacity-75 text-white" key={key}>
                                    ...
                                    <div className="card-body text-start fw-bold">
                                        ...
                                        <div className="card-text">LENGTH : {value.length}</div>
                                        <div className="card-text">CLASSIFICATION : {value.classification}</div>
                                        <div className="card-text">PROFILE : {value.profile}</div>
                                        <div className="card-text">SHAPE : {value.shape}</div>
                                        <div className="card-text">CORE : {value.core}</div>
                                        <div className="card-text">BASE : {value.base}</div>
